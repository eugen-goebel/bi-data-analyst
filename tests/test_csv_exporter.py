...
from agents.pattern_agent import CorrelationPair, Outlier, PatternAnalysis, TrendResult
from utils.csv_exporter import _sanitize_cell, export_analysis_csv, export_analysis_csv_string
    ...
    return PatternAnalysis(
        trends=[
            TrendResult(
                ...
                change_pct=15.3,
                description="Revenue shows steady growth",
            ),
        ],
        correlations=[
            CorrelationPair(
        ...
        outliers=[
            Outlier(
                ...
                row_index=42,
                z_score=3.2,
                description="Unusually high revenue in row 42",
            ),
        ],
        seasonal_patterns=[],
