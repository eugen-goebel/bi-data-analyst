...
Charts are generated by the Visualization Agent and embedded directly into the DOCX report. Examples produced from the bundled `sample_sales.csv`:

**Monthly Revenue Trend**: line chart with detected trend direction
![Revenue Trend](docs/screenshots/01-revenue-trend.png)

**Revenue by Region**: horizontal bar chart with value labels
![Revenue by Region](docs/screenshots/02-revenue-by-region.png)

**Revenue Distribution by Product Category**: share across categories
![Category Distribution](docs/screenshots/03-category-distribution.png)

**Correlation Heatmap**: Pearson correlations between all numeric variables
...
| Q4 Seasonal Spike | ~35% revenue increase in October to December |
